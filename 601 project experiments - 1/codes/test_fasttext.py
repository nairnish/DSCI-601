...
import sys
import pandas as pd
from project_fasttext import my_model
import fasttext
...
def test(train_data, validation_data, test_data, unlabelled_test_data):
    ...
    # Skipgram model :
    model = fasttext.train_unsupervised(r'./DSLCC4 datasets/DSL-TRAIN.txt', model='skipgram')

    # or, cbow model :
    # model = fasttext.train_unsupervised('./DSLCC4 datasets/DSL-TRAIN.txt', model='cbow')

    # model = fasttext.train_supervised('./DSLCC4 datasets/DSL-TRAIN.txt')
