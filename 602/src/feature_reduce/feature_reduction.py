...
class feature_reduction():
    ...
    '''
    Column Transformer - transforms feature generated by each transformer and concatenates to form single feature space 

    @param: df : Training/Testing dataset 
    @return: feature_set : Reduced / Concatenated feature set 
    '''
